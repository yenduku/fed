...
function HotelBillDemo(){
    ...
    const menu=[
        {itemName:"Burger",price:100},
        {itemName:"Pizza",price:150},
        {itemName:"Sandwich",price:120},
        {itemName:"Salad",price:80},
        {itemName:"Corn Masala",price:130},
    ];
    ...
    const findSum = () =>{
        ...
        <td>
        Front End Development Lab Manual Dept of CSE VVIT, Nambur
        {" "}
